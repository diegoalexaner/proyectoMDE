...
import concreta.diagram.edit.policies.DiagramaClasesCanonicalEditPolicy;
import concreta.diagram.edit.policies.DiagramaClasesItemSemanticEditPolicy;
import concreta.diagram.part.ConcretaVisualIDRegistry;

/**
 * @generated
 */
public class DiagramaClasesEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public DiagramaClasesEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DiagramaClasesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new DiagramaClasesCanonicalEditPolicy());
