...
import concreta.diagram.edit.policies.RelacionItemSemanticEditPolicy;
...
public class RelacionEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RelacionItemSemanticEditPolicy());
	}
