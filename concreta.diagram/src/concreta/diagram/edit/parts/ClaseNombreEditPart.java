 ...
 * @generated
 */
public class ClaseNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Clase_2002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ClaseNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
