 ...
 * @generated
 */
public class MetodoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Metodo_3003, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.MetodoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
