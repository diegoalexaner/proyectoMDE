...
import concreta.diagram.edit.policies.Clase2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Clase2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Clase2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Clase2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClaseNombre2EditPart) {
			((ClaseNombre2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureClaseLabelFigure());
			return true;
		}
		if (childEditPart instanceof ClaseClaseListaAtributosCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getClaseListaAtributosCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ClaseClaseListaAtributosCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ClaseClaseListaMetodosCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getClaseListaMetodosCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ClaseClaseListaMetodosCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ClaseClaseListaAtributosCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getClaseListaAtributosCompartmentFigure();
			pane.remove(((ClaseClaseListaAtributosCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ClaseClaseListaMetodosCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getClaseListaMetodosCompartmentFigure();
			pane.remove(((ClaseClaseListaMetodosCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ClaseClaseListaAtributosCompartmentEditPart) {
			return getPrimaryShape().getClaseListaAtributosCompartmentFigure();
		}
		if (editPart instanceof ClaseClaseListaMetodosCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ConcretaVisualIDRegistry.getType(ClaseNombre2EditPart.VISUAL_ID));
	}
