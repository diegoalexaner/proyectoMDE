 ...
 * @generated
 */
public class ParametroNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Parametro_3004, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ParametroNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
