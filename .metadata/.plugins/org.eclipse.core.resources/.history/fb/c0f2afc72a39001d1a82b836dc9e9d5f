 ...
 *   <li>{@link concreta.ModelFactory#getListaDiagramasClases <em>Lista Diagramas Clases</em>}</li>
 * </ul>
 *
...
public interface ModelFactory extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Lista Diagramas Clases</b></em>' containment reference list.
	 * The list contents are of type {@link concreta.DiagramaClases}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Lista Diagramas Clases</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Lista Diagramas Clases</em>' containment reference list.
	 * @see concreta.ConcretaPackage#getModelFactory_ListaDiagramasClases()
	 * @model containment="true"
	 * @generated
	 */
	EList<DiagramaClases> getListaDiagramasClases();
