...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Containment Abstracta</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link abstracta.impl.ContainmentAbstractaImpl#getSource <em>Source</em>}</li>
 *   <li>{@link abstracta.impl.ContainmentAbstractaImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link abstracta.impl.ContainmentAbstractaImpl#getMultiplicidadA <em>Multiplicidad A</em>}</li>
 *   <li>{@link abstracta.impl.ContainmentAbstractaImpl#getMultiplicidadB <em>Multiplicidad B</em>}</li>
 *   <li>{@link abstracta.impl.ContainmentAbstractaImpl#getRolA <em>Rol A</em>}</li>
 *   <li>{@link abstracta.impl.ContainmentAbstractaImpl#getRolB <em>Rol B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainmentAbstractaImpl extends EObjectImpl implements ContainmentAbstracta {
	/**
	 ...
	 * @generated
	 */
	protected ContainmentAbstractaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.CONTAINMENT_ABSTRACTA;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractaPackage.CONTAINMENT_ABSTRACTA__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(ClaseAbstracta newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.CONTAINMENT_ABSTRACTA__SOURCE, oldSource, source));
	}
	...
	public ClaseAbstracta getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractaPackage.CONTAINMENT_ABSTRACTA__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ClaseAbstracta newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.CONTAINMENT_ABSTRACTA__TARGET, oldTarget, target));
	}
	...
	public void setMultiplicidadA(String newMultiplicidadA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.CONTAINMENT_ABSTRACTA__MULTIPLICIDAD_A, oldMultiplicidadA, multiplicidadA));
	}
	...
	public void setMultiplicidadB(String newMultiplicidadB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.CONTAINMENT_ABSTRACTA__MULTIPLICIDAD_B, oldMultiplicidadB, multiplicidadB));
	}
	...
	public void setRolA(String newRolA) {
		...
		rolA = newRolA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.CONTAINMENT_ABSTRACTA__ROL_A, oldRolA, rolA));
	}
	...
	public void setRolB(String newRolB) {
		...
		rolB = newRolB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.CONTAINMENT_ABSTRACTA__ROL_B, oldRolB, rolB));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractaPackage.CONTAINMENT_ABSTRACTA__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case AbstractaPackage.CONTAINMENT_ABSTRACTA__TARGET:
