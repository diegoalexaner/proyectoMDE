...
/**
 * This is the item provider adapter for a {@link concreta.Metodo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetodoItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSentenciaPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretaPackage.Literals.METODO__NOMBRE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Sentencia feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSentenciaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metodo_sentencia_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metodo_sentencia_feature", "_UI_Metodo_type"),
				 ConcretaPackage.Literals.METODO__SENTENCIA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValorRetornoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Metodo_valorRetorno_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Metodo_valorRetorno_feature", "_UI_Metodo_type"),
				 ConcretaPackage.Literals.METODO__VALOR_RETORNO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcretaPackage.Literals.METODO__LISTA_PARAMETROS);
		}
	...
	public String getText(Object object) {
		String label = ((Metodo)object).getNombre();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.METODO__LISTA_PARAMETROS,
				 ConcretaFactory.eINSTANCE.createParametro()));
	}
