...
/**
 * This is the item provider adapter for a {@link concreta.Clase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretaPackage.Literals.CLASE__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addRutaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clase_ruta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clase_ruta_feature", "_UI_Clase_type"),
				 ConcretaPackage.Literals.CLASE__RUTA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcretaPackage.Literals.CLASE__LISTA_ATRIBUTOS);
			childrenFeatures.add(ConcretaPackage.Literals.CLASE__LISTA_METODOS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.CLASE__LISTA_ATRIBUTOS,
				 ConcretaFactory.eINSTANCE.createAtributo()));

		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.CLASE__LISTA_METODOS,
				 ConcretaFactory.eINSTANCE.createMetodo()));
	}
