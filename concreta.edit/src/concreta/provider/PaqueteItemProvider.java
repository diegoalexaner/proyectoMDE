...
/**
 * This is the item provider adapter for a {@link concreta.Paquete} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PaqueteItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Paquete_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Paquete_nombre_feature", "_UI_Paquete_type"),
				 ConcretaPackage.Literals.PAQUETE__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addRutaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Paquete_ruta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Paquete_ruta_feature", "_UI_Paquete_type"),
				 ConcretaPackage.Literals.PAQUETE__RUTA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcretaPackage.Literals.PAQUETE__LISTA_CLASES);
			childrenFeatures.add(ConcretaPackage.Literals.PAQUETE__LISTA_PAQUETES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.PAQUETE__LISTA_CLASES,
				 ConcretaFactory.eINSTANCE.createClase()));

		newChildDescriptors.add
			(createChildParameter
				(ConcretaPackage.Literals.PAQUETE__LISTA_PAQUETES,
